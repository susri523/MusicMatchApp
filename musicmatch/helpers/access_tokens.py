...
from .spotify_auth import getAuth, refreshAuth, getToken

#import spotify keys from config file
from ..config import CLIENT_ID, CLIENT_SECRET

#Port is 8000 and and callback url is localhost:8000
PORT = "8000"
...
def getUser():
    ...
    return getAuth(CLIENT_ID, "{}:{}/music/callback/".format(CALLBACK_URL, PORT), SCOPE)
...
def getUserToken(code):
    ...
    global TOKEN_DATA
    TOKEN_DATA = getToken(code, CLIENT_ID, CLIENT_SECRET, "{}:{}/music/callback/".format(CALLBACK_URL, PORT))
